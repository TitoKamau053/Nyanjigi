...
const generatePreviewMessage = () => {
    let preview = getAutoGeneratedMessage()
      ...
      .replace(/\{total_bill\}/g, '[Total Bill]')
      .replace(/\{contribution_balance\}/g, '[Contribution]') 
      .replace(/\{total_fines\}/g, '[Fines]');                 
          ...
          <div className="lg:col-span-2 bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 mt-2">
                  This message will be personalized for each recipient using their name, account number, and customer's financial balances.
                </p>
              </div>
